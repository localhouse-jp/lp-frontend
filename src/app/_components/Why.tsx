export default function Why() {
  return (
    <div className="flex flex-col lg:flex-row py-32 px-4 md:px-32 max-w-[1200px] md:mx-auto gap-12">
      <p className="font-bold min-w-[240px] text-2xl my-auto text-center">なぜ始めるのか？</p>
      <div className="flex flex-col min-w-[440px] gap-4">
        <p className="font-bold w-full text-xl">エンジニアが創造的な活動ができる場所を創りたい</p>
