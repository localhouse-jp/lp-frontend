import { lineSeed } from "@/common/util/font";

export default function Why() {
  return (
    <div className="flex flex-col lg:flex-row py-96 px-4 md:px-32 max-w-[1200px] md:mx-auto gap-12 justify-center">
      <p className="font-bold min-w-[240px] text-3xl my-auto text-center">なぜ始めるのか？</p>
      <div className="flex flex-col lg:max-w-[640px] max-w-full gap-4">
        <p className="font-bold w-full lg:text-2xl text-xl">エンジニアが創造的な活動ができる場所を創りたい</p>
        <p className={`${lineSeed.className}`}>エンジニアが技術を駆使して新しい価値を生み出すためには、自由に創造できる環境が必要です。<br />
