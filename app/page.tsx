    ...
    core: [
      {
        ...
        affiliation: language === "ja" ? "近畿大学情報学部B3" : "Kindai University, School of Information, Year 2",
      ...
      },
      {
        name: "シュレスタアロク",
        role: language === "ja" ? "メンバー" : "Member",
        affiliation: language === "ja" ? "大阪工業大学D2" : "Osaka Institute of Technology, D1",
        image: "/placeholder.svg",
      },
      {
        name: "Nova",
      ...
      },
      {
        ...
        answer:
          language === "ja"
            ...
            : "Unfortunately, general public usage is not available, but short-term use for hackathons and events is welcome.",
      },
    ],
  }
  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        <main>
          <Hero data={heroData} />
          <Features title="特徴" features={featuresData} />
          <Members
        ...
        <Footer sections={footerSections} copyright="© 2025 LOCALHOUSE. All rights reserved." />
      </motion.div>
    </AnimatePresence>
  )
}
